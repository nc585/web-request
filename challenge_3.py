...
#shorthand method using list comprehension (which can be used JUST for filtering purposes, or mapping purposes)

grades = [(student["finalGrade"] * 100) for student in parsed_response["students"]]
